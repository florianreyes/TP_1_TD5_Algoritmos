#ifndef TAXI_ASSIGNMENT_BATCHING_SOLVER_MOD_H
#define TAXI_ASSIGNMENT_BATCHING_SOLVER_MOD_H
...
class BatchingSolverMod
{
public:
    BatchingSolverMod();
    BatchingSolverMod(TaxiAssignmentInstance &instance);
